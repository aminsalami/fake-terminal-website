...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        ls_help: "List current directory.",
        cat_help: "Read FILE(s) content and print it to the standard output.",
        ...
        welcome: "Welcome to my terminal :) \n\nTo get help just ask for it! or maybe you can enter 'help' command.",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        "Linkedin.txt": "https://www.linkedin.com/in/amin-salami",
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
